...
loom {
	accessWidenerPath = file("src/main/resources/regui.accesswidener")
...
dependencies {
	...
	// https://github.com/ralf2oo2/betterf3-stapi
	modImplementation("maven.modrinth:betterf3-stationapi:${project.properties["betterf3_version"]}")
}
